"""Build a double-clickable "AV Trainer.app" with a real icon (macOS).

Creates the .app on the Desktop; the app just runs Start AV Trainer.command.
...
def main() -> None:
    ...
    runner.write_text(
        "#!/bin/bash\n"
        f'exec "{ROOT}/command_utilities/Start AV Trainer.command"\n')
    runner.chmod(0o755)
    ...
    plist = {
        ...
        "CFBundleIdentifier": "local.av-trainer",
        "CFBundleVersion": "1.0",
