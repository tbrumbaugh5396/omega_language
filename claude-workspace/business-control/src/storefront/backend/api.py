...
PRODUCT_KINDS = (
    ...
    {"id": "web", "label": "Websites", "colour": "#1f6fb8",
     "note": "the site itself — a week, or from scratch"},
    {"id": "brand", "label": "Branding", "colour": "#c2185b",
     "note": "identity, art direction, motion"},
    {"id": "build", "label": "Builds", "colour": "#b8431f",
     "note": "standing the platform up around it"},
