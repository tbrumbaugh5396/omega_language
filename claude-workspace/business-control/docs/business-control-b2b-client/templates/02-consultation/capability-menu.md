# The menu — what the system does, and what each part costs

**Client-facing.** Send it after the [free consultation](free-consultation.md),
with [how this works](packages-and-process.md). Fill the `[SQUARE BRACKETS]`,
delete what doesn't apply.

> **Send it, don't present it.** The point of a menu is that they read it
> without you in the room, at their own pace, and come back with the two or
> three lines they weren't sure about. Reading a price list aloud turns a
> scoping conversation into a haggle.

This page prices the **software you run on, monthly**. The
[packages](packages-and-process.md) price the **work to build it**, once. Two
...
| Lessons & progress | — | ✓ | ✓ | — |
| Donations & receipts | — | — | ✓ | ✓ |
| Staff time clock & jobs | ✓ | ✓ | ✓ | ✓ |
| Events | ✓ | — | ✓ | ✓ |
| Chat, voice & video | ✓ | ✓ | ✓ | ✓ |
| CRM & support desk | ✓ | ✓ | ✓ | ✓ |
| Email, A/B & pixels | ✓ | ✓ | — | — |
| Funnel, P&L & the owner's view | ✓ | ✓ | ✓ | ✓ |
| Nonprofit pricing applied | — | — | ✓ −30% | ✓ −30% |

**Selected:** ☐ Food brand ☐ Course business ☐ Language nonprofit ☐ Food bank
☐ Build my own, below

> Nothing here is locked. A bundle is a starting selection — add a capability
> the week you need it, drop one the month you don't.
...
| **Progressive App** — install to the home screen, offline shell, push-ready | — | $20 | ☐ |
...
## Then: how much of it you use

| | Included | Beyond that |
|---|---|---|
| **Locations** | 1 | +$29/mo each |
| **Staff seats** | 5 | +$7/mo each |

**A seat is someone who signs in to run the business.** Your customers, donors,
students and affiliates are free, however many of them there are — you are not
charged for being popular.

A few things cost us money every time they are used, so they are measured
rather than bundled. Included first, then per unit:

| | Included each month | Then |
|---|---|---|
| AI support chatbot | 200 conversations | $0.036 each |
| Email sends | 10,000 | $0.0003 each |
| Group video | — | $0.0025 per participant-minute |
| Voice interface | — | $0.09 per minute |
| SMS | — | $0.02 each |
...
exactly the month you can least afford a surprise.

Everything is month to month with **[30] days'** notice. Your data is yours:
one export, any time, in a format that opens.
...
| | |
|---|---|
| How many people will sign in to run the business? | |
| How many locations, sites or vans? | |
| Which of the capabilities above are **musts** for day one? | |
| Which are **wants** for month six? | |
| Anything you already pay for that this would replace? | |

> "Must" and "want" are different columns for a reason. Phase one is the musts;
> everything else is a decision you get to make later, with the thing in front
> of you.
