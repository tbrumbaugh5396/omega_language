...
- [finance-and-rules.md](finance-and-rules.md) — the ledger, the cash position, the legal diary, the rules engine, the payroll run, what is owed each way and the first fortnight: the seven capabilities that were priced before they were built, and what each still stops short of
