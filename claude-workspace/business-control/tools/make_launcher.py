"""Build a double-clickable "Business Control.app" with a real icon (macOS).

Creates the .app on the Desktop; the app just runs Start Business Control.command.
...
def main() -> None:
    ...
    runner.write_text(
        "#!/bin/bash\n"
        f'exec "{ROOT}/command_utilities/Start Business Control.command"\n')
    runner.chmod(0o755)
    ...
    plist = {
        ...
        "CFBundleIdentifier": "local.business-control",
        "CFBundleVersion": "1.0",
