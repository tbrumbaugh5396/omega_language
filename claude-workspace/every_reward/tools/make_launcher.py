"""Build a double-clickable "Every Reward.app" with a real icon (macOS).

Creates the .app on the Desktop; the app just runs Start Every Reward.command.
...
def main() -> None:
    ...
    runner.write_text(
        "#!/bin/bash\n"
        f'exec "{ROOT}/command_utilities/Start Every Reward.command"\n')
    runner.chmod(0o755)
    ...
    plist = {
        ...
        "CFBundleIdentifier": "local.every-reward",
        "CFBundleVersion": "1.0",
